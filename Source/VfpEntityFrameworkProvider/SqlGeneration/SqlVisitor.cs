...
namespace VfpEntityFrameworkProvider.SqlGeneration {
    internal class SqlVisitor : DbExpressionVisitorBase<ISqlFragment> {
        ...
        //public override ISqlFragment Visit(Expressions.SubqueryExpression expression) {
        //    throw new NotImplementedException();
        //}
        private delegate ISqlFragment FunctionHandler(SqlVisitor visitor, DbFunctionExpression functionExpr);
        ...
        private static ISqlFragment HandleCanonicalFunctionNotSupported(SqlVisitor visitor, DbFunctionExpression e) {
        ...
        public override ISqlFragment Visit(DbCommandTree expression) {
            throw new NotSupportedException();
        }

        public override ISqlFragment Visit(DbDeleteCommandTree expression) {
            throw new NotSupportedException();
        }

        public override ISqlFragment Visit(DbFunctionCommandTree expression) {
            throw new NotSupportedException();
        }

        public override ISqlFragment Visit(DbInsertCommandTree expression) {
            throw new NotSupportedException();
        }

        public override ISqlFragment Visit(DbQueryCommandTree expression) {
            throw new NotSupportedException();
        }

        public override ISqlFragment Visit(DbUpdateCommandTree expression) {
            throw new NotSupportedException();
        }

        public override ISqlFragment Visit(DbAndExpression e) {
            return this.VisitBinaryExpression(DbExpressionKind.And, e.Left, e.Right);
        }
        ...
        public override ISqlFragment Visit(DbParameterExpression expression) {
        ...
        public override ISqlFragment Visit(DbXmlToCursorPropertyExpression expression) {
            var result = new SqlBuilder();
        ...
        public override ISqlFragment Visit(DbXmlToCursorScanExpression expression) {
        ...
        public override ISqlFragment Visit(DbXmlToCursorExpression expression) {
            var result = new SqlBuilder();
        ...
        public override ISqlFragment Visit(DbInListExpression expression) {
            var result = new SqlBuilder();

            result.Append(expression.Property.Accept(this));

            DbExpression values = expression.Values;
            var notExpression = values as DbNotExpression;
            ...
            result.Append(" IN (");
            result.Append(values.Accept(this));
            result.Append(") ");

            return result;
        }

        public override ISqlFragment Visit(DbArrayExpression expression) {
            var result = new SqlBuilder();
        ...
        public override ISqlFragment Visit(DbNotExpression e) {
            ...
            if (comparisonExpression != null) {
                if (comparisonExpression.ExpressionKind == DbExpressionKind.Equals) {
                    return this.VisitBinaryExpression(DbExpressionKind.NotEquals, comparisonExpression.Left, comparisonExpression.Right);
                }
            }
        ...
        public override ISqlFragment Visit(DbOrExpression expression) {
            return this.VisitBinaryExpression(DbExpressionKind.Or, expression.Left, expression.Right);
        }
        ...
        public override ISqlFragment Visit(DbSkipExpression e) {
            ...
            SqlSelectStatement input2 = this.VisitDbSkipExpression_GetSqlSelectStatement(e, out inputColumns, out row_numberSymbol, true);
            input2.FromExtents[0].NeedsRenaming = true;

            SqlSelectStatement input = this.VisitDbSkipExpression_GetSqlSelectStatement(e, out inputColumns, out row_numberSymbol, false);

            input.From.Clear();
            input.From.Append("( ");
            input.From.Append(input2);
            input.From.AppendLine();
            input.From.Append(") ");
            input.From.Append(input.FromExtents[0].Name);
        ...
        public override ISqlFragment Visit(DbVariableReferenceExpression e) {
            ...
            this.isVarRefSingle = true; // This will be reset by DbPropertyExpression or MethodExpression
        ...
        public override ISqlFragment Visit(DbLikeCExpression e) {
            var result = new SqlBuilder();
        ...
        private SqlSelectStatement VisitDbSkipExpression_GetSqlSelectStatement(DbSkipExpression e, out List<Symbol> inputColumns, out Symbol row_numberSymbol, bool includeOrderBy) {
            //Visit the input
            Symbol fromSymbol;
            ...
            if (includeOrderBy) {
                ...
                input.Select.Append(", recno()");

                input.Select.Append(" AS ");
                row_numberSymbol = new Symbol("row_number", null);
        ...
        private static ISqlFragment HandleConcatFunction(SqlVisitor visitor, DbFunctionExpression e) {
            return visitor.HandleSpecialFunctionToOperator(e, false);
        }

        private static ISqlFragment HandleCanonicalFunctionBitwise(SqlVisitor visitor, DbFunctionExpression e) {
            return visitor.HandleSpecialFunctionToOperator(e, true);
        }

        private static ISqlFragment HandleCanonicalFunctionBitwiseAnd(SqlVisitor visitor, DbFunctionExpression e) {
            SqlBuilder result = new SqlBuilder();
        ...
        private static ISqlFragment HandleCanonicalFunctionBitwiseXor(SqlVisitor visitor, DbFunctionExpression e) {
            SqlBuilder result = new SqlBuilder();
            // TODO: code contract for e.Arguments.Count > 1
        ...
        private static ISqlFragment HandleCanonicalFunctionBitwiseOr(SqlVisitor visitor, DbFunctionExpression e) {
            SqlBuilder result = new SqlBuilder();
            // TODO: code contract for e.Arguments.Count > 1
        ...
        private static ISqlFragment HandleCanonicalFunctionBitwiseNot(SqlVisitor visitor, DbFunctionExpression e) {
            SqlBuilder result = new SqlBuilder();
            // TODO: code contract for e.Arguments.Count  = 1
        ...
        /// </summary>
        private static ISqlFragment HandleDatepartDateFunction(SqlVisitor visitor, DbFunctionExpression e) {
        ...
        private static ISqlFragment HandleCanonicalFunctionDatepart(SqlVisitor visitor, DbFunctionExpression e) {
        ...
        private static ISqlFragment HandleCanonicalFunctionCurrentDateTime(SqlVisitor visitor, DbFunctionExpression e) {
            return visitor.HandleFunctionDefaultGivenName(e, "DATETIME");
        }

        private static ISqlFragment HandleCanonicalFunctionCreateDateTime(SqlVisitor visitor, DbFunctionExpression e) {
            return visitor.HandleCanonicalFunctionDateTimeTypeCreation(e.Arguments);
        }

        private SqlBuilder ParanthesizeExpressionIfNeeded(DbExpression e) {
            SqlBuilder result = new SqlBuilder();
        ...
        private ISqlFragment HandleCanonicalFunctionDateTimeTypeCreation(IList<DbExpression> args) {
            SqlBuilder result = new SqlBuilder();
        ...
        private static ISqlFragment HandleCanonicalFunctionDateAdd(SqlVisitor visitor, DbFunctionExpression e) {
            SqlBuilder result = new SqlBuilder();
        ...
        private static ISqlFragment HandleCanonicalFunctionDateDiff(SqlVisitor visitor, DbFunctionExpression e) {
            SqlBuilder result = new SqlBuilder();
        ...
        private static ISqlFragment HandleCanonicalFunctionPower(SqlVisitor visitor, DbFunctionExpression e) {
            SqlBuilder result = new SqlBuilder();
        ...
        private static ISqlFragment HandleCanonicalFunctionSubstring(SqlVisitor visitor, DbFunctionExpression e) {
            SqlBuilder result = new SqlBuilder();
        ...
        private static ISqlFragment HandleCanonicalFunctionIndexOf(SqlVisitor visitor, DbFunctionExpression e) {
            SqlBuilder result = new SqlBuilder();
            DbFunctionExpression argument1 = e.Arguments[0] as DbFunctionExpression;
        ...
        private static ISqlFragment HandleCanonicalFunctionLength(SqlVisitor visitor, DbFunctionExpression e) {
            return visitor.HandleFunctionDefaultGivenName(e, "LEN");
        }

        private static ISqlFragment HandleCanonicalFunctionRound(SqlVisitor visitor, DbFunctionExpression e) {
            return visitor.HandleCanonicalFunctionRound(e);
        }

        private ISqlFragment HandleCanonicalFunctionRound(DbFunctionExpression e) {
            SqlBuilder result = new SqlBuilder();
        ...
        private static ISqlFragment HandleCanonicalFunctionAbs(SqlVisitor visitor, DbFunctionExpression e) {
        ...
        private static ISqlFragment HandleCanonicalFunctionTrim(SqlVisitor visitor, DbFunctionExpression e) {
            SqlBuilder result = new SqlBuilder();
        ...
        private static ISqlFragment HandleCanonicalFunctionTruncateTime(SqlVisitor visitor, DbFunctionExpression e) {
            SqlBuilder result = new SqlBuilder();
        ...
        private static ISqlFragment HandleCanonicalFunctionReplace(SqlVisitor visitor, DbFunctionExpression e) {
            return visitor.HandleFunctionDefaultGivenName(e, "STRTRAN");
        }

        private static ISqlFragment HandleCanonicalFunctionToLower(SqlVisitor visitor, DbFunctionExpression e) {
            return visitor.HandleFunctionDefaultGivenName(e, "LOWER");
        }

        private static ISqlFragment HandleCanonicalFunctionToUpper(SqlVisitor visitor, DbFunctionExpression e) {
        ...
        protected SqlBuilder VisitBinaryExpression(DbExpressionKind kind, DbExpression left, DbExpression right) {
            ...
            if (this.isProcessingFilter && this.HandleIndexOfWithStartsWithOrEndsWith(result, left, right)) {
                if (kind == DbExpressionKind.NotEquals) {
        ...
        /// <summary>
        /// EntityFramework seems to interpret StartsWith and EndWith commands as an IndexOf DbFunctionExpression.  This is not ideal as it would
        ...
        protected bool HandleIndexOfWithStartsWithOrEndsWith(SqlBuilder result, DbExpression left, DbExpression right) {
            DbFunctionExpression function = left as DbFunctionExpression;
            DbConstantExpression constant = right as DbConstantExpression;

            if (function != null && constant != null && function.Function.Name == "IndexOf" && constant.Value.ToString() == "1") {
                if (function.Arguments.Count > 0) {
                    DbFunctionExpression leftFunction = function.Arguments[0] as DbFunctionExpression;
                    DbFunctionExpression rightFunction = function.Arguments[1] as DbFunctionExpression;

                    if (leftFunction != null && leftFunction.Function.Name == "Reverse" && rightFunction != null && rightFunction.Function.Name == "Reverse") {
                        List<DbExpression> arguments = new List<DbExpression>();
        ...
        /// </summary>
        private static ISqlFragment HandleCanonicalFunctionContains(SqlVisitor visitor, DbFunctionExpression e) {
        ...
        /// </summary>
        private static SqlBuilder HandleCanonicalFunctionContains(SqlVisitor visitor, IList<DbExpression> args, SqlBuilder result) {
        ...
        private static ISqlFragment HandleCanonicalFunctionStartsWith(SqlVisitor visitor, DbFunctionExpression e) {
        ...
        /// </summary>
        protected static SqlBuilder HandleCanonicalFunctionStartsWith(SqlVisitor visitor, IList<DbExpression> args, SqlBuilder result) {
            Debug.Assert(args.Count == 2, "StartsWith should have two arguments");

            var property = args[0];
            var pattern = args[1];

            if (pattern is DbPropertyExpression) {
                property = args[1];
                pattern = args[0];
            }

            var constSearchParamExpression = pattern as DbConstantExpression;
        ...
        /// </summary>
        private static ISqlFragment HandleCanonicalFunctionEndsWith(SqlVisitor visitor, DbFunctionExpression e) {
        ...
        /// </summary>
        private static SqlBuilder HandleCanonicalFunctionEndsWith(SqlVisitor visitor, IList<DbExpression> args, SqlBuilder result) {
            Debug.Assert(args.Count == 2, "EndsWith should have two arguments");

            var property = args[0];
            var pattern = args[1];

            if (DbPropertyGatherer.Gather(pattern).Any()) {
                property = args[1];
                pattern = args[0];
            }
        ...
        /// </summary>
        private ISqlFragment WrapPredicate(Func<SqlVisitor, IList<DbExpression>, SqlBuilder, SqlBuilder> predicateTranslator, DbFunctionExpression e) {
            SqlBuilder result = new SqlBuilder();
        ...
        public ISqlFragment Visit(VfpProviderManifest vfpManifest, System.Data.Common.CommandTrees.DbQueryCommandTree commandTree, out List<DbParameter> parameters) {
            var queryCommandTree = GetCommandTreeExpression<DbQueryCommandTree>(vfpManifest, commandTree);
        ...
        protected T GetCommandTreeExpression<T>(VfpProviderManifest vfpManifest, System.Data.Common.CommandTrees.DbCommandTree commandTree) where T : DbCommandTree {
        ...
        protected List<DbParameter> GetParameters(DbExpression expression) {
        ...
        private ISqlFragment VisitNewInstanceExpression(DbNewInstanceExpression e) {
            ...
            if (null != rowType) {
                ...
                for (int i = 0; i < e.Arguments.Count; ++i) {
                    ...
                    DbPropertyExpression dbPropertyExpression = argument as DbPropertyExpression;

                    if (!columnName.EndsWith("." + member.Name) || dbPropertyExpression == null || dbPropertyExpression.Property.Name != member.Name) {
                        result.Append(" AS ");
