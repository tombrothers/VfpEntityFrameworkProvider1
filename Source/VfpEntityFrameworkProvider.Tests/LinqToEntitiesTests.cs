...
namespace VfpEntityFrameworkProvider.Tests {
    ...
    public class LinqToEntitiesTests : TestBase {
        ...
        public void LinqToEntities102() {
            ...
            var query = cq(this.GetContext(), new DateTime(1997, 1, 1));
        ...
        public void LinqToEntitiesFunctions_EntityFunctions() {
            var query = from o in context.Orders
                        where EntityFunctions.DiffYears(o.OrderDate, DateTime.Now) < 20
                        select o;
